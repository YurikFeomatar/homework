...
public class CalculatorWithCounterAutoDecoratorTest {
    private final ICalculator calc = new CalculatorWithCounterAutoDecorator(new CalculatorWithOperator());

    @Test
    @DisplayName("проверяем CalculatorWithCounterAutoDecorator")
